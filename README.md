...
* `class LexicalAnalyzer` uses the ctor() to invoke scanning/analysis of the inputstream. 
*		Instead, it should define a method to do this. 
*		This would add many useful benefits to make the code more robust and understandable
* Idea:
